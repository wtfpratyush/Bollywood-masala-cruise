...
export const popularCruises = [
  {
    ...
    details: {
      ...
      activities: [
        ...
        { icon: "🎵", name: "Antakshari", desc: "Sing along to your favorite Bollywood hits" },
        { icon: "💃", name: "Dance Showcase & Workshops", desc: "Watch & learn Bollywood dance" },
        { icon: "🎉", name: "Bollywood Dance Party", desc: "Dance the moment away" },
        { icon: "🎤", name: "Open Mic & Karaoke", desc: "Show off your singing talent on stage" },
        { icon: "🏆", name: "Games & Fun", desc: "Watch & participate in interactive games" },
      ],
