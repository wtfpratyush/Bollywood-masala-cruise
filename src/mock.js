...
export const popularCruises = [
  {
    ...
    details: {
      ...
      banner: "https://images.unsplash.com/photo-1599640842225-85d111c60e6b?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA1ODR8MHwxfHNlYXJjaHwzfHxsdXh1cnklMjBjcnVpc2UlMjBzaGlwfGVufDB8fHx8MTc4Nzc0ODIwMXww&ixlib=rb-4.1.0&q=85",
      ...
      itinerary: [
        { day: "Day 1", port: "Orlando, Port Canaveral", image: "https://images.unsplash.com/photo-1566438480900-0609be27a4be?crop=entropy&cs=srgb&fm=jpg&q=80&w=400" },
        { day: "Day 2", port: "Cruising Day", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?crop=entropy&cs=srgb&fm=jpg&q=80&w=400" },
        ...
        { day: "Day 4", port: "St. Thomas, US Virgin Islands", image: "https://images.unsplash.com/photo-1557804506-669a67965ba0?crop=entropy&cs=srgb&fm=jpg&q=80&w=400" },
        ...
        { day: "Day 7", port: "Great Stirrup Cay, Bahamas", image: "https://images.unsplash.com/photo-1548574505-5e239809ee19?crop=entropy&cs=srgb&fm=jpg&q=80&w=400" },
        { day: "Day 8", port: "Orlando, Port Canaveral", image: "https://images.unsplash.com/photo-1566438480900-0609be27a4be?crop=entropy&cs=srgb&fm=jpg&q=80&w=400" },
      ],
      rooms: [
        { name: "Inside Room", desc: "Cozy and comfortable, the inside room offers all essential amenities for a relaxing stay.", image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?crop=entropy&cs=srgb&fm=jpg&q=80&w=600" },
        { name: "Balcony Room", desc: "Enjoy stunning ocean views and fresh sea breezes from your private balcony.", image: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?crop=entropy&cs=srgb&fm=jpg&q=80&w=600" },
        { name: "Club Balcony Suite", desc: "Priority boarding and departure, dedicated entertainment seating, and more.", image: "https://images.unsplash.com/photo-1631049552057-403cdb8f0658?crop=entropy&cs=srgb&fm=jpg&q=80&w=600" },
      ],
      activities: [
      ...
      diningImage: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?crop=entropy&cs=srgb&fm=jpg&q=80&w=700",
  ...
  {
    tag: "MAR 2025",
    title: "Hot Cruise (Bahamas)",
    subtitle: "5 Nights | 3 Exotic Destinations",
    features: ["Luxury Stay", "All Meals Included", "Live Shows & DJ Nights", "Shore Excursions"],
    price: "$799",
    image: "https://images.unsplash.com/photo-1583157048761-ac1dba033233?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA2MDV8MHwxfHNlYXJjaHwzfHxjcnVpc2UlMjBzaGlwJTIwb2NlYW58ZW58MHx8fHwxNzg3NzQ4MjA3fDA&ixlib=rb-4.1.0&q=85",
    details: {
      dates: "MAR 14, 2025 – MAR 19, 2025",
      ship: "Norwegian Sky",
      banner: "https://images.unsplash.com/photo-1548574505-5e239809ee19?crop=entropy&cs=srgb&fm=jpg&q=80&w=1200",
      tagline: "5 nights of pure Bollywood magic sailing through the crystal-clear waters of the Bahamas. Dance, dine, and soak in the sun!",
      included: ["Meals", "Accommodation", "Entertainment", "Activities"],
      itinerary: [
        { day: "Day 1", port: "Miami, Florida", image: "https://images.unsplash.com/photo-1533106418989-88406c7cc8ca?crop=entropy&cs=srgb&fm=jpg&q=80&w=400" },
        { day: "Day 2", port: "Nassau, Bahamas", image: "https://images.pexels.com/photos/2166553/pexels-photo-2166553.jpeg?auto=compress&cs=tinysrgb&w=400" },
        { day: "Day 3", port: "Great Stirrup Cay", image: "https://images.unsplash.com/photo-1548574505-5e239809ee19?crop=entropy&cs=srgb&fm=jpg&q=80&w=400" },
        { day: "Day 4", port: "Cruising Day", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?crop=entropy&cs=srgb&fm=jpg&q=80&w=400" },
        { day: "Day 5", port: "Key West, Florida", image: "https://images.pexels.com/photos/1430672/pexels-photo-1430672.jpeg?auto=compress&cs=tinysrgb&w=400" },
        { day: "Day 6", port: "Miami, Florida", image: "https://images.unsplash.com/photo-1533106418989-88406c7cc8ca?crop=entropy&cs=srgb&fm=jpg&q=80&w=400" },
      ],
      rooms: [
        { name: "Inside Room", desc: "Cozy and comfortable, the inside room offers all essential amenities for a relaxing stay.", image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?crop=entropy&cs=srgb&fm=jpg&q=80&w=600" },
        { name: "Balcony Room", desc: "Enjoy stunning ocean views and fresh sea breezes from your private balcony.", image: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?crop=entropy&cs=srgb&fm=jpg&q=80&w=600" },
      ...
      activities: [
        ...
        { icon: "🎉", name: "Bollywood Dance Party", desc: "Dance the night away to Bollywood hits" },
        { icon: "🎤", name: "Open Mic & Karaoke", desc: "Show off your singing talent on stage" },
        { icon: "🏖️", name: "Beach BBQ Night", desc: "Enjoy a special BBQ evening on the private island" },
      ],
      diningImage: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?crop=entropy&cs=srgb&fm=jpg&q=80&w=700",
      diningDesc: "Enjoy a range of meals onboard, including Indian vegetarian and non-vegetarian dishes, as well as international favorites.",
      testimonials: [
        { name: "Sunita R.", rating: 5, avatar: "https://i.pravatar.cc/80?img=33", text: "The Bahamas cruise was absolutely magical! The food was phenomenal, especially the Indian buffet nights. We made lifelong friends on this trip. The entertainment team was incredible!" },
        { name: "Deepak M.", rating: 5, avatar: "https://i.pravatar.cc/80?img=11", text: "What a trip! The pool deck garba under the stars was unlike anything we've experienced. Perfectly organized, no stress, just pure fun. Already booked for next year!" },
...
export const pastCruises = [
  { date: "JAN 2025", title: "Alaska Cruise", image: "https://images.pexels.com/photos/5022610/pexels-photo-5022610.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" },
